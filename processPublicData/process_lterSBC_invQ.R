...
################################
# RAW DATASET IS READY, PREP FOR BTS ANALYSIS
################################
...
with(invW, table(st, YEAR))

# some year x st combos have two - these are mistakes
dubs <- invW %>% group_by(YEAR, st) %>%
...
tempDat <- filter(invW, sty == "MOHK_2_2002" |
                    sty == "ABUR_1_2003" |
                    sty == "BULL_1_2003" |
                    sty == "GOLB_2_2003" |
                    sty == "IVEE_1_2003")

invW2 <- filter(invW, sty != "MOHK_2_2002" &
                  sty != "ABUR_1_2003" &
                  sty != "BULL_1_2003" &
                  sty != "GOLB_2_2003" &
                  sty != "IVEE_1_2003")
...
invW3 <- rbind(invW2, tempDat2)

with(invW3, table(st, YEAR))

invW4 <- droplevels(filter(invW3, st != "AQUE_6" &
                             st != "IVEE_3" &
                             st != "IVEE_4" &
                             st != "IVEE_5" &
                             st != "IVEE_6" &
